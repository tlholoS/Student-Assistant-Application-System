...
label: const Text('New Application', style: TextStyle(color: Colors.white, fontWeight:
FontWeight.bold)),
...
Text(
label,
style: GoogleFonts.outfit(fontSize: 14, color: Colors.grey.shade500, fontWeight:
FontWeight.w500),
),
],
),
...
child: InkWell(
borderRadius: BorderRadius.circular(24),
onTap: () => NavigationService.navigateTo(RouteConstants.applicationDetails, arguments:
app),
child: Padding(
...
style: GoogleFonts.outfit(fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: -
0.5),
),
...
_buildIconLabel(Icons.auto_awesome_mosaic_rounded,
'${app.selectedModules.length} Modules'),
],
),
],
),
